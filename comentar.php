...
$sql = "INSERT INTO tb_comments (Autor, Email, Dia, Hora, Conteudo, Imagem, AutImg, Id_Posts) VALUES ('$nome_usuario', '$email_usuario', '$data', '$hora', '$conteudo', '$caminhoImagem', '$imagem_usuario', '$idPost')";

if (mysql_query($sql)) {
    header("Location: toggle_comentar.php?idPost=". $idPost );
    exit();
} else {
